...
Проект реализует консольное приложение, принимающее изображения в формате BMP и применяющее к ним необходимые фильтры.

## Поддерживаемый формат изображений

Входные и выходные файлы используют 24-битный BMP без сжатия и таблицы цветов. Тип используемого `DIB header` - `BITMAPINFOHEADER`.
